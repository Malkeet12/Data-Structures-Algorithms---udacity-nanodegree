...
class Tree():
    ...
    def insert_with_loop(self, new_value):
        ...
        node = self.get_root()
        while True:
            if self.compare(node, Node(new_value)) == 1:
            ...
            elif self.compare(node, Node(new_value)) == -1:
    ...
    def search(self, value):
        ...
        def search_recursive(node, new_node):
            if self.compare(node, new_node) == 1:
                if node.has_right_child():
                    return search_recursive(node.get_right_child(), new_node)
                else:
                    return False
            elif self.compare(node, new_node) == -1:
                if node.has_left_child():
                    return search_recursive(node.get_left_child(), new_node)
                else:
                    return False
            else:
                return True

        return search_recursive(node, Node(value))
