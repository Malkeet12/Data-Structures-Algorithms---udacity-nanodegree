...
with open('calls.csv', 'r') as f:
    ...
    for item in calls:
        ...
        if item[0].startswith('(080)') and receiver_number_prefix not in prefixes_called:
            prefixes_called.append(receiver_number_prefix)
    ...
    print("{:.2f} percent of calls from fixed lines in Bangalore are calls to other fixed lines in Bangalore.".format(
        called_fixed_lines_in_banglore_count / len(prefixes_called)))
