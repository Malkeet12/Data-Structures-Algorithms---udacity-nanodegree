...
# An LRU cache is a type of cache in which we remove the least recently used entry when the cache
# memory reaches its limit. For the current problem, consider both get and set operations as an use operation.
#
